...
// --- competences ---
// (id, nom, image, type)  — un seul type par compétence, plus de parent_id
$competences = [
    [1, "PHP", "images/competences/logo-PHP.png", "Langage"],
    [2, "SQL", "images/competences/logo-SQL.png", "Langage"],
    [3, "HTML", "images/competences/logo-HTML.png", "Langage"],
    [4, "CSS", "images/competences/logo-CSS.png", "Langage"],
    [5, "JavaScript", "images/competences/logo-JavaScript.png", "Langage"],
    [6, "Python", "images/competences/logo-Python.png", "Langage"],
    [7, "Snap.js", "images/competences/logo-Snap.svg", "Librairie"],
    [8, "GSAP", "images/competences/logo-GSAP.jpg", "Librairie"],
    [9, "WordPress", "images/competences/logo-WordPress.png", "CMS"],
    [10, "Visual Studio Code", "images/competences/logo-Visual_Studio_Code.png", "Outil"],
    [11, "MySQL", "images/competences/logo-MySQL.png", "Back"],
    [12, "Figma", "images/competences/logo-Figma.svg", "Design"],
    [13, "InDesign", "images/competences/logo-InDesign.png", "Design"],
    [14, "Illustrator", "images/competences/logo-Illustrator.png", "Design"],
    [15, "Photoshop", "images/competences/logo-Photoshop.png", "Design"],
    [16, "Symfony", "images/competences/logo-Symfony.png", "Framework"],
    [17, "Twig", "images/competences/logo-Twig.png", "Librairie"],
    [20, "THREE.JS", "images/competences/logo-THREE.JS.png", "Librairie"],
    [21, "React", "images/competences/logo-React.png", "Framework"],
    [22, "Next.js", "images/competences/logo-Next.js.png", "Framework"],
    [23, "Ammo.js", "images/competences/logo-Ammo.js.png", "Librairie"],
];

$insertCompetence = $pdo->prepare(
    "INSERT INTO competences (id_competence, nom_competence, image_competence, type_competence, description)
     VALUES (?, ?, ?, ?, NULL)"
);
...
// --- projets ---
// (id, titre, texte, annee, categorie, url, github, illustration)
$projets = [
    [
        1,
        "Site | MaMusique",
        ...
        "images/Projets/MaMusique/1.png",
    ],
    [
        2,
        ...
        "images/Projets/Site Tonnerre 2 Zeus/1.png",
    ],
    [
        3,
        "Site | TheGuardian",
        ...
        "images/Projets/TheGuardian/1.png",
    ],
    [
        4,
        ...
        null,
        "images/Projets/Site ADPT/1.webp",
    ],
    [
        5,
        "Jeu | TwoSeeToSee",
        ...
        "images/Projets/TwoSeeToSee/1.png",
    ],
];

$insertProjet = $pdo->prepare(
    "INSERT INTO projets (id_projet, titre_projet, texte_projet, annee_projet, categorie_projet, url_projet, urlGitHub_projet, illustration_projet)
     VALUES (?, ?, ?, ?, ?, ?, ?, ?)"
);
...
// --- images_projet ---
// Ne pas inclure "1.png" ici : c'est déjà l'illustration principale de chaque
// projet (cf. $projets ci-dessus), le carrousel la rajoute automatiquement en tête.
$imagesProjet = [
    [1, 1, "images/Projets/MaMusique/2.png"],
    [2, 1, "images/Projets/MaMusique/3.png"],
    ...
    [8, 3, "images/Projets/TheGuardian/2.png"],
];
...
// --- projet_competence (à ajuster de ton côté) ---
$projetCompetence = [
